...
RAW_DATA_DENSE_FP = RAW_DATA_DIR/"Single_cell_atlas_of_peripheral_immune_response_to_SARS_CoV_2_infection.h5ad"
RAW_DATA_FP   = RAW_DATA_DIR/"covid19.h5ad"
SUBSAMPLED_DATA_DIR = RAW_DATA_DIR/"covid19_subsampled.h5ad"
DATA_SPLIT_FPS = [
